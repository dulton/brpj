...
-- Created by wyx on 2014-9-11, 16:12:27 --
-------------------------------------------

spool ushow2_0911.log
...
comment on column TB_MISSION.userid
  is '操作用户ID';
comment on column TB_MISSION.detectip
  is '识别服务器IP';
...
begin
  ...
  insert into tb_alarm_car
    ...
    select SEQ_MATCH_RESULT_car.Nextval,
           a.SCARNUMBER,
           BPICTURE,
           DCREATE,
           SFILE,
...
begin
  ...
  insert into tb_alarm_VEHICLE
    ...
    select SEQ_MATCH_RESULT_VEHICLE.Nextval,
           a.SCARNUMBER,
           BPICTURE,
           DCREATE,
           SFILE,
