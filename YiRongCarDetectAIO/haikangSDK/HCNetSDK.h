...
#define NET_DVR_SET_AUDIOCHAN                   1321    //音频通道切换
#define NET_DVR_GET_AUDIOCHAN_STATUS            1322    //获取音频切换状态
...
#define LONG_CFG_TYPE_GET_STREAM_INFO			6023  //获取已添加的流ID信息
...
#define  DS_B20_MCU_T               406     //netra主控
...
typedef struct 
{
    ...
    /*分辨率0-DCIF 1-CIF, 2-QCIF, 3-4CIF, 4-2CIF 5（保留）,6-QVGA(320*240), 7-QQVGA(160*120),
...
{
	DWORD dwSize;
	BYTE  byStatus;      //音频切换状态，1-已切换，0-未切换
	BYTE  byRes1[3];
	//以下参数当byStatus == 1时有效
...
typedef struct tagNET_DVR_CMD_TRIGGER_PERIOD_RECORD_PARA
{
	...
	BYTE					byEventID[MAX_DOMAIN_NAME];		//事件ID，作为附加信息
	BYTE					byRes[128];
