...
//汽车
	if(MySqlIO.CAR_BlackTable_ReadOne(i,data))
#else
//电动车
	if(MySqlIO.ELECAR_BlackTable_ReadOne(i,data))
#endif
	{
		// 生成子节点：row
...
#if ALLTAB_DETECT_CAR_MODE
//汽车
	total=MySqlIO.CAR_BlackTable_GetNum();

#else
//电动车
	total=MySqlIO.ELECAR_BlackTable_GetNum();
