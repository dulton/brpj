...
void CDLGHistoryVideo::DisplayerList(void)
{
	...
	if(ListTotal%HISTORY_VIDEO_PAGE_MAX_NUM)
	{
		sprintf(str,"共%d条 %d/%d页 每页%d条",
			ListTotal,
			ListNow/HISTORY_VIDEO_PAGE_MAX_NUM+1,ListTotal/HISTORY_VIDEO_PAGE_MAX_NUM+1,HISTORY_VIDEO_PAGE_MAX_NUM);
	}
	else
	{
		sprintf(str,"共%d条 %d/%d页 每页%d条",
			ListTotal,
			ListNow/HISTORY_VIDEO_PAGE_MAX_NUM+1,ListTotal/HISTORY_VIDEO_PAGE_MAX_NUM,HISTORY_VIDEO_PAGE_MAX_NUM);
	}
