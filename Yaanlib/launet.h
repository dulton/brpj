...
CNET_APIIMPORT BOOL  __stdcall VSNET_StartServerRecord_RecNameDiskSN(char *m_sername,char *m_url,char m_ch,char *m_username,char *m_password,int lRecordType,WORD wserport, IN OUT VSNETSERVERRECPARAM_ZGHY *m_pServerRecParam);
